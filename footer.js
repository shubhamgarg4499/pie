document.write(`  <footer class="footer-area">
      ...
      <div class="row g-4">
        <div class="col-lg-5">
          <div class="footer-widget-box about-us">
            ...
            <p class="mb-4">
              ...
              solvent based primers and some specialised Chemicals.Our Raw Materials sourced from reliable chemical
              manufacturers and traders around the globe
            </p>
        ...
        <div class="col-6 col-lg-2">
          <div class="footer-widget-box list">
            ...
            <ul class="footer-list">
              <li>
                <a href="service.html"><i class="far fa-angle-double-right"></i>Acrylic Emulsions</a>
              </li>
              <li>
                <a href="service.html"><i class="far fa-angle-double-right"></i>Water Based Adhesives
                </a>
              </li>
              <li>
                <a href="service.html"><i class="far fa-angle-double-right"></i>Solvent Based Primers</a>
              </li>
              <li>
                <a href="service.html"><i class="far fa-angle-double-right"></i>Specialised Chemicals</a>
              </li>
          ...
          <div class="footer-widget-box">
            ...
            <ul class="footer-contact">
              <li>
                ...
                <div class="content">
                  <h6>Our Address</h6>
                  <p>Plot No : 69, Sector - 57, Phase - 4, HSIIDC Kundli Sonipat, Haryana</p>
                </div>
              </li>
              <li>
                <div class="icon">
                ...
                <div class="content">
                  <h6>Call Us</h6>
                  <a href="tel:+21236547898">+91-9999807180</a>
                </div>
              </li>
              <li>
                <div class="icon">
                ...
                <div class="content">
                  ...
                  <a href="/"><span class="__cf_email__"
                      data-cfemail="4a23242c250a2f322b273a262f64292527">piechemicals@gmail.com</span></a>
                </div>
              </li>
            </ul>
          </div>
    ...
    <div class="row">
      <div class="col-md-6 align-self-center">
        <p class="copyright-text">
          ...
          <a href="#"> PIE </a> All Rights Reserved.
        </p>
      </div>
      <div class="col-md-6 align-self-center">
